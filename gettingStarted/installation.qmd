...
Blue requires Java 25 or greater JDK (Java Developer Kit) to be
installed on your system, as well as Csound. Windows and macOS builds 
of Blue include JDKs with them and run out-of-the-box. Linux users 
will have to find a Java 25 installation.
